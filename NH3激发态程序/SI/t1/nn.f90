...
module nn_class
  ...
  contains
  !----------------------------------------------------------------------------
  subroutine nn_init(this)    !NN结构初始化
        implicit none
        class(nn) :: this
  ...
  !----------------------------------------------------------------------------
  subroutine copy_wb(this)    !wc,wb赋值为w,b
        implicit none
        class(nn) :: this
        this%wc=this%w
        this%bc=this%b
  ...
  !---------------------------------------------------------------------------
  subroutine rec_wb(this)     !又把w,b赋值为wc,bc
        implicit none
        class(nn) :: this
        this%w=this%wc
        this%b=this%bc
  ...
  !---------------------------------------------------------------------------
  subroutine nn_output(this,x)      !NN输出
        implicit none
        class(nn) :: this
  ...
  !----------------------------------------------------------------------------
  subroutine update_wb(this,dx)     !更新w,b
        implicit none
        class(nn) :: this
